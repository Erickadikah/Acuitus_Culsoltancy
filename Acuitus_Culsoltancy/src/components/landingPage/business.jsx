  ...
  return (
    <div className="bussiness">
      <div className="inner" style={{ marginBottom: "20px" }}>
        ...
        >
          Business{" "}
          <span style={{ color: "black", fontWeight: "bold" }}>Services</span>
        </h1>
        <h6
        ...
        <div className="bis-cont">
          <AnimatePresence>
            ...
            >
              ...
              <h4 className="bis-Txt">Capacity Building</h4>
              <ul className="list">
                <li>
                ...
                <li>
                  Financial literacy & entrepreneurship Gender equality and
                  women
                </li>
                ...
                <li>Youth Training & mentorship</li>
              </ul>
          ...
          <div className="bis-card">
            ...
            <ul className="list">
              <p className="small-header">Product Research</p>
              <li>
                Collect consumer feedback about either a new product or a new
                product concept.
              </li>
              <br />
              <p className="small-header">Attitude Research</p>
              <li>
                We gather consumer's and business client's feedback regarding
                experience with particular brands, products, and services
              </li>
              <br />
              <p className="small-header">Public Policy Research</p>
              <li>
                Measure social change and impact, develop projection tools, run
                experiments and cost-benefit analysis
              </li>
            </ul>
            <a href="/services">
              <button className="btn-s">Read More</button>
